...
import { useProductAddContext, useProductSusContext } from '../providers/ProductsProviders'

const Hijo: React.FC = () => {

    const user = useUserContext();
    const cambiaLogin = useUserToggleContext();
    const addProducts = useProductAddContext();
    const productSus = useProductSusContext();
    ...
    return(
        <>
            ...
            <div className='grid__productos'>
                ...
                <span className='gird__productos--title'>
                    Nuevo Producto
                </span>
